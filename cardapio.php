...
<body>
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-auto">
        <a href="cadastraCardapio2.php" class="btn btn-success" id="buttonNovoCardapio">Adicionar Cardapio</a>
      </div>
    </div>
    <div class="row">
      <div class="col-12">
        <table class="table">
          <thead>
            <tr>
              ...
              <th scope="col">Hora do intervalo</th>
          ...
          <tbody id="tabelaCardapio">
            <?php while ($dados = mysqli_fetch_array($query)) { ?>
              <tr>
                <td><?php echo $dados['dia_cardapio'] ?></td>
                <td><?php echo $dados['horario_cardapio'] ?></td>
                <td><?php echo $dados['alimento'] ?></td>
                <td colspan="2" class="text-center"><a class='btn btn-info btn-sm' href='editaCardapio.php?cod_cardapio=<?php echo $dados['cod_cardapio'] ?>'><i class="fa-solid fa-pencil"></i></a>
                    <a class='btn btn-danger btn-sm' href='#' onclick='confirmar("<?php echo $dados['cod_cardapio'] ?>")'><i class="fa-solid fa-trash-can"></i></a></td>
                </tr>
            <?php } ?>
        </table>
    </div>
